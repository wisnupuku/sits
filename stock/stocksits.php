...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update stocksits set nama_barang='$nama_barang', stock='$stock' where idx='$idx'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= stocksits.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from stocksits where idx='$idx'");
    ...
    <body>
      ...
      <div class="sidebar-menu">
            ...
            <?php 
				...
				$periksa_bahan=mysqli_query($conn,"select * from stocksits where stock <1");
            ...
            <?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['nama_barang']. "</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
											$brgs=mysqli_query($conn,"SELECT * from stocksits order by idx ASC");
											$no=1;
                                ...
                                <a href="export_sits_stock.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="tmb_sits_stock.php" method="post">
