...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update cctv_dokgiat_koordinir set tanggal='$tanggal',lokasi='$lokasi', kegiatan='$kegiatan' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from cctv_dokgiat_koordinir where idx='$idx'");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li>
                                    <span>Daftar Giat Koordinir Satgas</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>Daftar Giat Koordinir Satgas</h2>
                                    <button
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
											$brgs=mysqli_query($conn,"SELECT * from cctv_dokgiat_koordinir order by idx ASC");
											$no=1;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Hapus Giat
                                                                    <?php echo $p['tanggal']?>
                                                                    -
                                                                    <?php echo $p['lokasi']?>
                                                                    -
                                                                    <?php echo $p['kegiatan']?></h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                ...
                                <a href="exportcctv_dokgiat_koordinir.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form
                    action="tmb_cctv_dokgiat_koordinir.php"
                    method="post"
