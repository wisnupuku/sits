...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $ruangan = $_POST['status'];

        $updatedata = mysqli_query($conn,"update status_ruangan set tanggal='$tanggal', id_ruangan='$id_ruangan', status='$status' where id='$id'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= kebersihan.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"DELETE FROM status_ruangan where id='$id'");
                            ...
                            <ul class="metismenu" id="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">Inventaris Barang</a>
                                            <ul class="collapse">
                                                <li>
                                ...
                                <li class="active">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li>
                                            <a href="eva_inven.php">Inventaris Evaluator</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Giat Kebersihan</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from status_ruangan order by id ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <?php
                                                    $det = mysqli_query($conn,"select * from ruangan where id = ". $id_Ruangan);
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit <?php echo $p['tanggal']?> - <?php echo $p['id_ruangan']?></h4>
                                                            ...
                                                            <input type="text" id="lokasi" name="lokasi" class="form-control" value="<?php echo $p['ID_ruangan'] ?>">

                                                            <label for="lokasi">Lantai</label>
                                                            <input type="text" id="lokasi" name="lokasi" class="form-control" value="<?php echo $p['ID_ruangan'] ?>">

                                                            <label for="keterangan">Status</label>
                                                            <input type="text" id="keterangan" name="keterangan" class="form-control" value="<?php echo $p['status'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus <?php echo $p['tanggal']?> - <?php echo $p['lokasi']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
									...
									<a href="export_eva_dokgiat.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_eva_dokgiat.php" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label>Tanggal</label>
									<input name="tanggal" type="date" class="form-control" placeholder="dd/mm/yyyy" required>
								</div>
								<div class="form-group">
									<label>Lokasi</label>
