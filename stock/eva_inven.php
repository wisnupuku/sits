...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update eva_inven set tanggal='$tanggal',nama='$nama', jumlah='$jumlah'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= eva_inven.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from eva_inven where idx='$idx'");
      ...
      <div class="sidebar-menu">
        ...
        <div class="main-content">
			...
			<?php 
				...
				$periksa_bahan=mysqli_query($conn,"select * from eva_inven where jumlah <1");
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['jumlah']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['tanggal']. "</u> <u>".($p['nama'])."</u> &nbsp <u>".$p['jumlah']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Inventaris Evaluator</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Daftar Inventaris Evaluator</h2>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from eva_inven order by idx ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Barang <?php echo $p['tanggal']?> - <?php echo $p['nama']?> - <?php echo $p['jumlah']?></h4>
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Barang <?php echo $p['tanggal']?> - <?php echo $p['nama']?> - <?php echo $p['jumlah']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
									...
									<a href="exportevainven.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_inveneva.php" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label>Jumlah</label>
									<input name="jumlah" type="number" min="0" class="form-control" placeholder="Qty">
								</div>
