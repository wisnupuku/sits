...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', jenis='$jenis',  ukuran='$ukuran', satuan='$satuan', lokasi='$lokasi' where idx='$idx'");
    ...
    <body>
        ...
        <div class="page-container">
                        ...
                        <nav>
                            <ul class="metismenu" id="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        <li>
                                            <a href="masuk.php">Barang Masuk / Kembali</a>
                                        </li>
                                        <li>
            ...
            <?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['nama']. "</u> <u>".$p['ukuran']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
                ...
                <form action="tmb_brg_act.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            type="text"
                            class="form-control"
                            placeholder="Jenis / Kategori Barang">
                    </div>
                    <div class="form-group">
                        <label>Ukuran</label>
