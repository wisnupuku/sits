...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatdataskrg = mysqli_query($conn,"select * from eva_invenmasuk where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $updatedata1 = mysqli_query($conn,"update eva_invenmasuk set tglmasuk='$tglmasuk', jumlah='$jumlah' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='1; url= eva_inven_masuk.php'/>  ";
                } else { echo "<div class='alert alert-warning'>
                    <strong>Failed!</strong> Redirecting you back in 3 seconds.
                </div>
                <meta http-equiv='refresh' content='3; url= eva_inven_masuk.php'/> ";
                };
            ...
            $updatedata = mysqli_query($conn,"update eva_invenmasuk set tglmasuk='$tglmasuk', jumlah='$jumlah' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $del = mysqli_query($conn,"delete from eva_invenmasuk where id='$id'");
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * from  eva_invenmasuk sb, eva_invenstock st where st.idx=sb.idx order by sb.id DESC");
											$no=1;
                                    ...
                                    <a href="export_eva_masuk.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="tmb_eva_masuk.php" method="post">
