...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update stockcctv set serial='$serial', tipe='$tipe', jenis='$jenis', tahun='$tahun', stock='$stock', tglkontrak='$tglkontrak', paket='$paket' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from stockcctv where idx='$idx'");
        ...
        <div class="page-container">
           ...
           <div class="sidebar-menu">
            ...
            <?php 
				...
				$periksa_bahan=mysqli_query($conn,"select * from stockcctv where stock <1");
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
											$brgs=mysqli_query($conn,"SELECT * from stockcctv order by idx ASC");
											$no=1;
											...
											?>
                                                ...
                                                <a href="export_cctv_stock.php" target="_blank" class="btn btn-info">Export Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="myModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="tmb_stockcctv.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    type="number"
                                    class="form-control"
                                    placeholder="Jumlah Stock" hidden   >
                            </div>
