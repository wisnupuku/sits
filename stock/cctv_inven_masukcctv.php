...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatstock = mysqli_query($conn,"select * from stockcctv where idx='$idx'"); //lihat stock barang itu saat ini
        $stocknya = mysqli_fetch_array($lihatstock); //ambil datanya
        $stockskrg = $stocknya['stock'];//jumlah stocknya skrg

        $lihatdataskrg = mysqli_query($conn,"select * from masukcctv where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query($conn,"update stockcctv set stock='$tambahistock' where idx='$idx'");
            $updatedata1 = mysqli_query($conn,"update masukcctv set tglmasuk='$tglmasuk',jumlah='$jumlah',lokasi='$lokasi',keterangan='$keterangan' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='1; url= cctv_inven_masukcctv.php'/>  ";
                } else { echo "<div class='alert alert-warning'>
                    <strong>Failed!</strong> Redirecting you back in 3 seconds.
                </div>
                <meta http-equiv='refresh' content='3; url= cctv_inven_masukcctv.php'/> ";
                };
            ...
            $query1 = mysqli_query($conn,"update stockcctv set stock='$kurangistock' where idx='$idx'");

            $updatedata = mysqli_query($conn,"update masukcctv set tglmasuk='$tglmasuk', jumlah='$jumlah', lokasi='$lokasi', keterangan='$keterangan' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $queryx = mysqli_query($conn,"update stockcctv set stock='$adjuststock' where idx='$idx'");
        $del = mysqli_query($conn,"delete from masukcctv where id='$id'");
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * from  masukcctv sb, stockcctv st where st.idx=sb.idx order by sb.id DESC");
											$no=1;
                                    ...
                                    <a href="export_cctv_masuk.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="barang_masuk_act_cctv.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="serial" class="custom-select form-control">
                                <option selected="selected">Pilih barang</option>
                                <?php
									$det=mysqli_query($conn,"select * from stockcctv order by serial ASC");
									while($d=mysqli_fetch_array($det)){
									?>
                                <option value="<?php echo $d['idx'] ?>"><?php echo $d['serial'] ?></option>
                                <?php
								}
								?>
                            </select>
                        ...
                        <div class="form-group">
                            <label>Lokasi</label>
                            <input name="lokasi" type="text" min="1" class="form-control" placeholder="lokasi">
                        </div>
                        <div class="form-group">
