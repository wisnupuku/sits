...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatdataskrg = mysqli_query($conn,"select * from keluarcctv where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query($conn,"update stockcctv set stock='$kurangistock' where idx='$idx'");
            $updatedata1 = mysqli_query($conn,"update keluarcctv set tglkeluar='$tglkeluar',jumlah='$jumlah',lokasi='$lokasi',penerima='$penerima',keterangan='$keterangan' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='3; url= cctv_inven_keluarcctv.php'/> ";
                };
            ...
            $query1 = mysqli_query($conn,"update stockcctv set stock='$tambahistock' where idx='$idx'");

            $updatedata = mysqli_query($conn,"update keluarcctv set tglkeluar='$tglkeluar', jumlah='$jumlah', lokasi='$lokasi', penerima='$penerima', keterangan='$keterangan' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $del = mysqli_query($conn,"delete from keluarcctv where id='$id'");
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * FROM keluarcctv sb, stockcctv st where st.idx=sb.idx ORDER BY id DESC");
											$no=1;
                                        ...
                                        <a href="export_cctv_keluar.php" target="_blank" class="btn btn-info">Export Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="myModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="barang_keluar_act_cctv.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="barang" class="custom-select form-control">
                                    ...
                                    <?php
									$det=mysqli_query($conn,"select * from stockcctv order by serial ASC")or die(mysqli_error());
