...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatdataskrg = mysqli_query($conn,"select * from masuksits where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query($conn,"update stocksits set stock='$tambahistock' where idx='$idx'");
            $updatedata1 = mysqli_query($conn,"update masuksits set tanggal='$tanggal',jumlah='$jumlah', lokasi='$lokasi',keterangan='$keterangan' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='1; url= masuksits.php'/>  ";
                } else { echo "<div class='alert alert-warning'>
                    <strong>Failed!</strong> Redirecting you back in 3 seconds.
                </div>
                <meta http-equiv='refresh' content='3; url= masuksits.php'/> ";
                };
            ...
            $query1 = mysqli_query($conn,"update stocksits set stock='$kurangistock' where idx='$idx'");

            $updatedata = mysqli_query($conn,"update masuksits set tanggal='$tanggal', jumlah='$jumlah', keterangan='$keterangan' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $del = mysqli_query($conn,"delete from masuksits where id='$id'");
                        ...
                        <nav>
                            <ul class="metismenu" id="menu">
                                ...
                                <li  class="active">
                                    ...
                                    <ul class="collapse">
                                        <li>
                                            <a href="sits_bukutamu.php">Buku Tamu Pengembalian Rekaman</a>
                                        </li>
                                        <li  class="active">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * from  masuksits sb, stocksits st where st.idx=sb.idx order by sb.id DESC");
											$no=1;
                                    ...
                                    <a href="export_sits_masuk.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form action="barang_masuk_act.php" method="post">
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input name="tanggal" type="date" class="form-control" placeholder="dd/mm/yyyy"
                            required="required">
                        ...
                        <div class="form-group">
                            ...
                            <select name="barang" class="custom-select form-control">
                                ...
                                <?php
									$det=mysqli_query($conn,"select * from stocksits order by nama_barang ASC");
