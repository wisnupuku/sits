...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatdataskrg = mysqli_query($conn,"select * from masukmaterial where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query($conn,"update stockmaterial set stock='$tambahistock' where idx='$idx'");
            $updatedata1 = mysqli_query($conn,"update masukmaterial set tglmasuk='$tglmasuk',jumlah='$jumlah', lokasi='$lokasi',keterangan='$keterangan' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='3; url= cctv_inven_masukmaterial.php'/> ";
                };
            ...
            $query1 = mysqli_query($conn,"update stockmaterial set stock='$kurangistock' where idx='$idx'");

            $updatedata = mysqli_query($conn,"update masukmaterial set tglmasuk='$tglmasuk', jumlah='$jumlah', lokasi='$lokasi', keterangan='$keterangan' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $del = mysqli_query($conn,"delete from masukmaterial where id='$id'");
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * from  masukmaterial sb, stockmaterial st where st.idx=sb.idx order by sb.id DESC");
											$no=1;
                                    ...
                                    <a href="export_cctv_masukmaterial.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="barang_masuk_act_material.php" method="post">
                        <div class="form-group">
                            <label>Tanggal Masuk</label>
                            <input name="tglmasuk" required type="date" class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="serial" class="custom-select form-control">
                                ...
                                <?php
									$det=mysqli_query($conn,"select * from stockmaterial order by serial ASC");
