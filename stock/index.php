    ...
    <div class="page-container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:black; padding:0px;">
                            <!-- <img src="dishub.png" width="300px" class="user-name dropdown-toggle" data-toggle="dropdown"\> -->
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up"><center>
            <img src="sits.png" class="img-responsive">
            <figcaption>
              <a href=""><h3>Surabaya Intelligent Transport System</h3></a>
            </figcaption>
            </center>
            <a href="#"></a>
          </figure>
        ...
        <div  class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up"><center>
            <img src="dishub.png" class="img-responsive">
            <figcaption>
              <a href="https://dishub.surabaya.go.id/portal/"><h3>Dinas Perhubungan Kota Surabaya</h3></a>
            </figcaption>
            </center>
            <a href="#"></a>
          </figure>
        ...
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up"><center>
            <img src="word-image.png" class="img-responsive" width="260 px">
            <figcaption>
              <a href="https://www.surabaya.go.id/"><h3>Pemerintah Kota Surabaya</h3></a>
            </figcaption>
            </center>
            <a href="#"></a>
          </figure>
        ...
        <!-- footer area start-->
        <!-- <footer>
            <div class="footer-area"><center> <p>By Richard's Lab</p></center>
