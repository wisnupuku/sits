...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update eva_invenstock set tanggal='$tanggal', kode='$kode',nama='$nama', stock='$stock'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= eva_inven_stock.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from eva_invenstock where idx='$idx'");
      ...
      <div class="sidebar-menu">
        ...
        <div class="main-content">
			...
			<?php 
				...
				$periksa_bahan=mysqli_query($conn,"select * from eva_invenstock where stock <1");
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['stock']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".($p['nama'])."</u> &nbsp <u>".$p['stock']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from eva_invenstock order by idx ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Hapus Barang <?php echo $p['nama']?> - <?php echo $p['stock']?></h4>
									...
									<a href="export_eva_stock.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_eva_stock.php" method="post" enctype="multipart/form-data">
