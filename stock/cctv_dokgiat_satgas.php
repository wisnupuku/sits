...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update cctv_dokgiat_satgas set tanggal='$tanggal', jam='$jam', lokasi='$lokasi', kegiatan='$kegiatan', progres='$progres', maintener='$maintener', tglup='$tglup' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from cctv_dokgiat_satgas where idx='$idx'");
        //hapus juga semua data barang ini di tabel keluar-masuk
        $deltabelkeluar = mysqli_query($conn,"delete from cctv_dokgiat_satgas where idx='$idx'");
        $deltabelmasuk = mysqli_query($conn,"delete from cctv_dokgiat_satgas where idx='$idx'");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li>
                                    <span>Daftar Giat Satgas CCTV</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
											$brgs=mysqli_query($conn,"SELECT * from cctv_dokgiat_satgas order by idx ASC");
											$no=1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="assets/images/sits/<?= $p['sebelum']; ?>" target="_blank">
                                                        <img src="assets/images/sits/<?= $p['sebelum']; ?>" style="width: 100px;">
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="assets/images/sits/<?= $p['sesudah']; ?>" target="_blank">
                                                        <img src="assets/images/sits/<?= $p['sesudah']; ?>" style="width: 100px;">
                                                    </a>
                                                </td>
                                                <td><?php echo $p['lokasi'] ?></td>
                                                <td><?php echo $p['kegiatan'] ?></td>
                                                <td><?php echo $p['progres'] ?></td>
                                                <td><?php echo $p['maintener'] ?></td>
                                                <td><?php echo $p['tglup'] ?></td>
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Edit Dokumentasi Giat Satgas
                                                                    <?php echo $p['tanggal']?>
                                                                    -
                                                                    <?php echo $p['maintener']?>
                                                                    -
                                                                    <?php echo $p['tglup']?>
                                                                </h4>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <label for="progres">Progres</label>
                                                                    ...
                                                                    name="progres"
                                                                    class="form-control"
                                                                    value="<?php echo $p['progres'] ?>">
                                                                
                                                                <label for="maintener">Maintener</label>
                                                                    <input
                                                                    type="text"
                                                                    id="maintener"
                                                                    name="maintener"
                                                                    class="form-control"
                                                                    value="<?php echo $p['maintener'] ?>">
                                                                
                                                                <label for="tglup">Tanggal Up</label>
                                                                    <input
                                                                    type="text"
                                                                    id="tglup"
                                                                    name="tglup"
                                                                    class="form-control"
                                                                    value="<?php echo $p['tglup'] ?>">
                                                                 
                                                                    
                                                                <input type="hidden" name="idx" value="<?=$idb;?>">
                                                                <!-- <label for="stock">jumlah</label> <input type="text" id="stock"
                                                                name="stock" class="form-control" value="<?php echo $p['stock'] ?>" disabled>
                                                                -->

                                                                <!-- <label for="ktp">KTP</label> <input type="file" id="ktp" name="ktp"
                                                                class="form-control" value="<?php echo $p['ktp'] ?>"> -->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Hapus Giat?</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                ...
                                <a href="exportsits_cctv_dokgiat_satgas.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form
                    action="tmb_cctv_dokgiat_satgas.php"
                    method="post"
                    ...
                    <div class="form-group">
                        <label>Maintener</label>
                        <input
                            name="maintener"
                            type="text"
                            class="form-control"
                            placeholder="Maintener"
                            required="required">
                    </div>
                    <div class="form-group">
                        <label>Tanggal Up</label>
                        <input
                            name="tglup"
                            type="date"
                            class="form-control"
                            placeholder="Tanggal UP"
                            required="required">
                    </div>
