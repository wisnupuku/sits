...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatstock = mysqli_query($conn,"select * from stocksits where idx='$idx'"); //lihat stock barang itu saat ini
        $stocknya = mysqli_fetch_array($lihatstock); //ambil datanya
        $stockskrg = $stocknya['stock'];//jumlah stocknya skrg

        $lihatdataskrg = mysqli_query($conn,"select * from keluarsits where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query($conn,"update stocksits set stock='$kurangistock' where idx='$idx'");
            $updatedata1 = mysqli_query($conn,"update keluarsits set tanggal='$tanggal',jumlah='$jumlah', lokasi='$lokasi',penerima='$penerima',keterangan='$keterangan' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='1; url= keluarsits.php'/>  ";
                } else { echo "<div class='alert alert-warning'>
                    <strong>Failed!</strong> Redirecting you back in 3 seconds.
                </div>
                <meta http-equiv='refresh' content='3; url= keluarsits.php'/> ";
                };
            ...
            $query1 = mysqli_query($conn,"update stocksits set jumlah='$tambahistock' where idx='$idx'");

            $updatedata = mysqli_query($conn,"update keluarsits set tanggal='$tanggal', jumlah='$jumlah','lokasi=$lokasi', penerima='$penerima', keterangan='$keterangan' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $queryx = mysqli_query($conn,"update stocksits set stock='$adjuststock' where idx='$idx'");
        $del = mysqli_query($conn,"delete from keluarsits where id='$id'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * FROM keluarsits sb, stocksits st where st.idx=sb.idx ORDER BY id DESC");
											$no=1;
                                ...
                                <a href="export_sits_keluar.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="barang_keluar_act.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="barang" class="custom-select form-control">
                            ...
                            <?php
									$det=mysqli_query($conn,"select * from stocksits order by nama_barang ASC")or die(mysqli_error());
									while($d=mysqli_fetch_array($det)){
									?>
                            <option value="<?php echo $d['idx'] ?>"><?php echo $d['nama_barang'] ?>
                          </option>
                            <?php
								}
								?>
