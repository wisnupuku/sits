                                                            ...
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        name="nama"
                                                                        class="form-control"
                                                                        value="<?php echo $b['nama'] ?>  <?php echo $b['jenis'] ?>"
                                                                        disabled="disabled">
                    ...
                    <div class="form-group">
                        ...
                        <select name="barang" class="custom-select form-control">
                            ...
                            <?php
									...
									?>
                            <option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?>
                                
                                <?php echo $d['jenis'] ?>, Uk.
                                <?php echo $d['ukuran'] ?>
                                --- Stock :
                                <?php echo $d['stock'] ?></option>
                                <!-- WISNU -->
                            <?php
								}
								?>
