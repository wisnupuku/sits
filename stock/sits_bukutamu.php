...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sits_bukutamu set tanggal='$tanggal', nama='$nama', no_telp='$no_telp', instansi='$instansi', keperluan='$keperluan', lokasi='$lokasi', surat='$surat' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from sits_bukutamu where idx='$idx'");
        //hapus juga semua data barang ini di tabel keluar-masuk
        $deltabelkeluar = mysqli_query($conn,"delete from sits_bukutamu where idx='$idx'");
        $deltabelmasuk = mysqli_query($conn,"delete from sits_bukutamu where idx='$idx'");
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
											$brgs=mysqli_query($conn,"SELECT * from sits_bukutamu order by idx ASC");
											$no=1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="assets/images/sits/<?= $p['ktp']; ?>" target="_blank">
                                                        <img src="assets/images/sits/<?= $p['ktp']; ?>" style="width: 100px;">
                                                    </a>
                                                </td>
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Edit Buku Tamu
                                                                    <?php echo $p['nama']?>
                                                                    -
                                                                    <?php echo $p['instansi']?>
                                                                    -
                                                                    <?php echo $p['lokasi']?></h4>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input
                                                                    ...
                                                                    name="keperluan"
                                                                    class="form-control"
                                                                    value="<?php echo $p['keperluan'] ?>">

                                                                <label for="lokasi">Lokasi CCTV</label>
                                                                <input
                                                                    type="text"
                                                                    id="lokasi"
                                                                    name="lokasi"
                                                                ...
                                                                <br>
                                                                    <input type="radio" id="surat" name="surat" value="Ada"/>Ada
                                                                    <input
                                                                        type="radio"
                                                                        id="surat"
                                                                        name="surat"
                                                                        value="Tidak <?php echo $p['surat'] ?>">Tidak Ada
                                                                </br>
                                ...
                                <a href="exportsits_bukutamu.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form
                    ...
                    <div class="form-group">
                        ...
                        <input name="no_telp" type="text" min="0" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                    <input
                    required type="radio" id="surat" name="surat" value="Ada"/>Ada
                    <input
                    required
                        type="radio"
                        id="surat"
                        name="surat"
                        value="Tidak"/>Tidak Ada
                    </br>
            </div>
                </div>
                <div class="modal-footer">
