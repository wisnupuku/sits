...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update cctv_dokgiat_pemasangan set tanggal='$tanggal',lokasi='$lokasi', kegiatan='$kegiatan' where idx='$idx'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= cctv_dokgiat_pemasangan.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from cctv_dokgiat_pemasangan where idx='$idx'");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Giat Pemasangan CCTV</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Daftar Giat Pemasangan CCTV</h2>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from cctv_dokgiat_pemasangan order by idx ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Giat</h4>
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Giat <?php echo $p['tanggal']?> - <?php echo $p['lokasi']?> - <?php echo $p['kegiatan']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus giat ini?
                                                            <input type="hidden" name="idx" value="<?=$idb;?>">
                                                            </div>
									...
									<a href="exportcctv_dokgiat_pemasangan.php" target="_blank" class="btn btn-info">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_cctv_dokgiat_pemasangan.php" method="post" enctype="multipart/form-data">
