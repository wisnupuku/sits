...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $lihatstock = mysqli_query($conn,"select * from stockmaterial where idx='$idx'"); //lihat stock barang itu saat ini
        $stocknya = mysqli_fetch_array($lihatstock); //ambil datanya
        $stockskrg = $stocknya['stock'];//jumlah stocknya skrg

        $lihatdataskrg = mysqli_query($conn,"select * from keluarmaterial where id='$id'"); //lihat qty saat ini
        ...
        if($jumlah >= $qtyskrg){
            ...
            $queryx = mysqli_query($conn,"update stockmaterial set stock='$kurangistock' where idx='$idx'");
            $updatedata1 = mysqli_query($conn,"update keluarmaterial set tglkeluar='$tglkeluar',jumlah='$jumlah',penerima='$penerima',keterangan='$keterangan' where id='$id'");
            ...
            if ($updatedata1 && $queryx){
                ...
                <meta http-equiv='refresh' content='1; url= cctv_inven_keluarmaterial.php'/>  ";
                } else { echo "<div class='alert alert-warning'>
                    <strong>Failed!</strong> Redirecting you back in 3 seconds.
                </div>
                <meta http-equiv='refresh' content='3; url= cctv_inven_keluarmaterial.php'/> ";
                };
            ...
            $query1 = mysqli_query($conn,"update stockmaterial set stock='$tambahistock' where idx='$idx'");

            $updatedata = mysqli_query($conn,"update keluarmaterial set tglkeluar='$tglkeluar', jumlah='$jumlah', penerima='$penerima', keterangan='$keterangan' where id='$id'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $queryx = mysqli_query($conn,"update stockmaterial set stock='$adjuststock' where idx='$idx'");
        $del = mysqli_query($conn,"delete from keluarmaterial where id='$id'");
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php 
											$brg=mysqli_query($conn,"SELECT * FROM keluarmaterial sb, stockmaterial st where st.idx=sb.idx ORDER BY id DESC");
											$no=1;
                                                                ...
                                                                <div class="modal-content">
                                                                    <form method="post">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <label for="serial">Barang</label>
                                                                            <input
                                                                                type="text"
                                                                                id="serial"
                                                                                name="serial"
                                                                                class="form-control"
                                                                                value="<?php echo $b['serial'] ?>"
                                                                                disabled>
                                        ...
                                        <a href="export_cctv_keluarmaterial.php" target="_blank" class="btn btn-info">Export Data</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="myModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="barang_keluar_act_material.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="barang" class="custom-select form-control">
                                    ...
                                    <?php
									$det=mysqli_query($conn,"select * from stockmaterial order by serial ASC")or die(mysqli_error());
									while($d=mysqli_fetch_array($det)){
									?>
                                    <option value="<?php echo $d['idx'] ?>"><?php echo $d['serial'] ?>
                                    </option>
                                    <?php
								}
								?>
