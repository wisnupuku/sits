...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update eva_dokgiat set lokasi='$lokasi', tanggal='$tanggal', keterangan='$keterangan' where idx='$idx'");
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"DELETE FROM eva_dokgiat where idx='$idx'");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Giat Evaluator</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from eva_dokgiat order by idx ASC");
											$no=1;
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit <?php echo $p['tanggal']?> - <?php echo $p['lokasi']?></h4>
